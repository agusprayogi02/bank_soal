...
const contrastTextBold = TextStyle(
    color: lightC, fontFamily: 'Poppins', fontWeight: FontWeight.w600);
...
const inputFieldTextStyle = TextStyle(
    fontFamily: 'Poppins', fontWeight: FontWeight.w400, color: dartPrimaryC);
...
const inputFieldHintPaswordTextStyle = TextStyle(
    fontFamily: 'Poppins', color: Color(0xff444444), letterSpacing: 1);
