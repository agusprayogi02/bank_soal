...
const contrastText = TextStyle(color: lightC, fontFamily: 'Poppins');
const contrastTextBold =
    TextStyle(color: lightC, fontFamily: 'Poppins', fontWeight: FontWeight.w600);

const h3 = TextStyle(
    color: Colors.black, fontSize: 24, fontWeight: FontWeight.w800, fontFamily: 'Poppins');

const h4 = TextStyle(
    color: Colors.black, fontSize: 18, fontWeight: FontWeight.w700, fontFamily: 'Poppins');

const h5 = TextStyle(
    color: Colors.black, fontSize: 18, fontWeight: FontWeight.w500, fontFamily: 'Poppins');
...
const priceText = TextStyle(
    color: Colors.black, fontSize: 16, fontWeight: FontWeight.bold, fontFamily: 'Poppins');
...
const inputFieldPasswordTextStyle =
    TextStyle(fontFamily: 'Poppins', fontWeight: FontWeight.w500, letterSpacing: 3);

const inputFieldHintPaswordTextStyle =
    TextStyle(fontFamily: 'Poppins', color: Color(0xff444444), letterSpacing: 1);
...
const authPlateDecoration = BoxDecoration(
    ...
    boxShadow: [
      BoxShadow(
          color: Color.fromRGBO(0, 0, 0, .1), blurRadius: 10, spreadRadius: 5, offset: Offset(0, 1))
    ],
